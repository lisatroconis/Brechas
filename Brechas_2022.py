# -*- coding: utf-8 -*-
"""
Created on Sat Apr 30 17:52:01 2022
...
# Bases GIFMM
PINx = pd.read_excel("C:/Users/Lisa/Documents/Bases de Python/Dashboard de Brechas SAN/PIN 2022.xlsx")
MTAx = pd.read_excel("C:/Users/Lisa/Documents/Bases de Python/Dashboard de Brechas SAN/Meta 2022.xlsx")
...
## PiN 2022
PINx.columns
# Agregar el codigo divipola a PIN 2022
# de diferentes maneras, se genera una función que estandarice el texto, para 
# cualquier caso

# Estandarizando nombres de departamentos ...
PINx['Departamento'] = standardize_territories(PINx['Departamento'])


# Adicionar el divipola más adecuado
PINx = pd.merge(PINx, divdp, how= 'left', left_on = 'Departamento',
                 right_on = 'Departamento')
...
if PINx['dpto'].isna().sum() > 1:
    print('Ajustar Divipola dpto')

# Renombrar variables
PINx.rename(columns={"Vocación en permanencia": "Vocación de permanencia"}, inplace=True)


## Pivotear base de datos (Pasar a estrutura larga)
# Generación de Id para pivote
PINx.insert(7,'id',PINx.index + 1, True )
...
PINx.rename(columns={"variable": "Grupo poblacional", "value": "Total PIN 2022"}, 
             inplace=True)
PINx.columns
#--------------------------------------------------------------------------------#
## Meta 2021
# Renombrar variables
MTAx.rename(columns={"Vocación en permanencia": "Vocación de permanencia"}, inplace=True)
...
# Estandarizando nombres de departamentos ...
MTAx['Departamento'] = standardize_territories(MTAx['Departamento'])


# Adicionar el divipola más adecuado
MTAx = pd.merge(MTAx, divdp, how= 'left', left_on = 'Departamento',
                 right_on = 'Departamento')
...
MTAx.rename(columns={"variable": "Grupo poblacional", "value": "Total Meta 2022"}, 
             inplace=True)
#--------------------------------------------------------------------------------#
...
Ac_In['Control'] = Ac_In['Total 5w'] + Ac_In['Total PIN 2022'] + Ac_In['Total Meta 2022']
...
Ac_In = Ac_In[['Sector','dpto','Departamento','longitud','latitud','Grupo poblacional',
               'Total 5w','Total PIN 2022','Total Meta 2022']]#'Financiación',
...
# Exportar base final
Ac_In.to_excel("C:/Users/Lisa/Documents/Bases de Python/Dashboard de Brechas SAN/base_brechas_2022.xlsx",index=False)
